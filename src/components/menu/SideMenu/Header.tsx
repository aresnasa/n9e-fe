...
const getLogoSrc = (collapsed: boolean, sideMenuBgMode: string, siteInfo?: any) => {
  if (!collapsed) {
    if (sideMenuBgMode === 'light') {
      return siteInfo?.light_menu_big_logo_url || '/image/inesa-white.svg';
    }
    return siteInfo?.menu_big_logo_url || '/image/inesa-white.svg';
  }
  if (sideMenuBgMode === 'light') {
    return siteInfo?.light_menu_small_logo_url || '/image/inesa-white.svg';
  }
  return siteInfo?.menu_small_logo_url || '/image/inesa-white.svg';
};
